...
default_prompt: "Use $godogen to build or update this Babylon.js browser game from a natural-language design brief."
description: |
  Generate or update a complete Babylon.js browser game from a natural-language description. Use when the user wants Codex to make, rebuild, or substantially extend a Babylon.js project end to end.
---
